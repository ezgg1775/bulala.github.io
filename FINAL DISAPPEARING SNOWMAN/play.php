...
<h1>Welcome</h1>
    ...
    <main>
        ...
        <div></div>
    <!-- Display the game elements here -->
    <!-- ... (your HTML code for the game elements) -->

    <!-- Add the "Again" button -->
    <form method="POST" action="play.php"> <br>
        <input type="submit" name="again" value="Play Again">
    </form><br>

    <a href="highscore.html"><button>HIGH SCORE</button></a><br>
